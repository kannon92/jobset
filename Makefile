...
openapi-gen:
	...
	if [ $(GOPATH)/src/sigs.k8s.io/jobset/api/jobset/v1beta1/openapi_generated.go != $(PROJECT_DIR)/api/jobset/v1beta1/openapi_generated.go ]; then \
		mv $(GOPATH)/src/sigs.k8s.io/jobset/api/jobset/v1beta1/openapi_generated.go $(PROJECT_DIR)/api/jobset/v1beta1/openapi_generated.go; \
	fi
