...
func GetOpenAPIDefinitions(ref common.ReferenceCallback) map[string]common.OpenAPIDefinition {
	return map[string]common.OpenAPIDefinition{
		"sigs.k8s.io/jobset/api/jobset/v1alpha1.FailurePolicy":       schema_jobset_api_jobset_v1beta1_FailurePolicy(ref),
		"sigs.k8s.io/jobset/api/jobset/v1alpha1.JobSet":              schema_jobset_api_jobset_v1beta1_JobSet(ref),
		"sigs.k8s.io/jobset/api/jobset/v1alpha1.JobSetList":          schema_jobset_api_jobset_v1beta1_JobSetList(ref),
		"sigs.k8s.io/jobset/api/jobset/v1alpha1.JobSetSpec":          schema_jobset_api_jobset_v1beta1_JobSetSpec(ref),
		"sigs.k8s.io/jobset/api/jobset/v1alpha1.JobSetStatus":        schema_jobset_api_jobset_v1beta1_JobSetStatus(ref),
		"sigs.k8s.io/jobset/api/jobset/v1alpha1.Network":             schema_jobset_api_jobset_v1beta1_Network(ref),
		"sigs.k8s.io/jobset/api/jobset/v1alpha1.ReplicatedJob":       schema_jobset_api_jobset_v1beta1_ReplicatedJob(ref),
		"sigs.k8s.io/jobset/api/jobset/v1alpha1.ReplicatedJobStatus": schema_jobset_api_jobset_v1beta1_ReplicatedJobStatus(ref),
		"sigs.k8s.io/jobset/api/jobset/v1alpha1.StartupPolicy":       schema_jobset_api_jobset_v1beta1_StartupPolicy(ref),
		"sigs.k8s.io/jobset/api/jobset/v1alpha1.SuccessPolicy":       schema_jobset_api_jobset_v1beta1_SuccessPolicy(ref),
	}
}
