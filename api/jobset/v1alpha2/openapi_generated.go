...
func schema_jobset_api_jobset_v1alpha2_JobSetScheduling(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		...
		Dependencies: []string{
			"k8s.io/api/scheduling/v1alpha3.PodGroupSchedulingConstraints", "k8s.io/api/scheduling/v1alpha3.PodGroupSchedulingPolicy", "sigs.k8s.io/jobset/api/jobset/v1alpha2.ReplicatedJobSchedulingPolicy"},
	}
}
...
func schema_jobset_api_jobset_v1alpha2_ReplicatedJobSchedulingPolicy(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		...
		Dependencies: []string{
			"k8s.io/api/scheduling/v1alpha3.PodGroupResourceClaim", "k8s.io/api/scheduling/v1alpha3.PodGroupSchedulingConstraints", "k8s.io/api/scheduling/v1alpha3.PodGroupSchedulingPolicy"},
	}
}
