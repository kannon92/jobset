...
func (in *JobSetScheduling) DeepCopyInto(out *JobSetScheduling) {
	*out = *in
	if in.Policy != nil {
		...
		*out = new(schedulingv1alpha3.PodGroupSchedulingPolicy)
		(*in).DeepCopyInto(*out)
	}
	if in.Constraints != nil {
		in, out := &in.Constraints, &out.Constraints
		*out = new(schedulingv1alpha3.PodGroupSchedulingConstraints)
		(*in).DeepCopyInto(*out)
	}
	if in.Disruption != nil {
		in, out := &in.Disruption, &out.Disruption
		*out = new(schedulingv1alpha3.DisruptionMode)
		**out = **in
	}
...
func (in *ReplicatedJobSchedulingPolicy) DeepCopyInto(out *ReplicatedJobSchedulingPolicy) {
	*out = *in
	...
	if in.ResourceClaims != nil {
		...
		*out = make([]schedulingv1alpha3.PodGroupResourceClaim, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
