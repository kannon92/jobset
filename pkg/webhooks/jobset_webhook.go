...
//+kubebuilder:webhook:path=/mutate-jobset-x-k8s-io-v1beta1-jobset,mutating=true,failurePolicy=fail,sideEffects=None,groups=jobset.x-k8s.io,resources=jobsets,verbs=create;update,versions=v1beta1,name=mjobset.kb.io,admissionReviewVersions=v1
...
//+kubebuilder:webhook:path=/validate-jobset-x-k8s-io-v1beta1-jobset,mutating=false,failurePolicy=fail,sideEffects=None,groups=jobset.x-k8s.io,resources=jobsets,verbs=create;update,versions=v1beta1,name=vjobset.kb.io,admissionReviewVersions=v1
