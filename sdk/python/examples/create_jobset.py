...
replicated_job = (
    jobset.models.jobset_v1beta1_replicated_job.Jobsetv1beta1ReplicatedJob(
        name="main",
        replicas=1,
        template=job_template,
    )
)
jobset_example = jobset.models.jobset_v1beta1_job_set.Jobsetv1beta1JobSet(
    api_version="jobset.x-k8s.io/v1beta1",
    kind="JobSet",
    metadata=V1ObjectMeta(name="test-jobset"),
    spec=jobset.models.jobset_v1beta1_job_set_spec.Jobsetv1beta1JobSetSpec(
